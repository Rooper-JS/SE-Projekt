...
function handleDataset(dataset) {
    ...
    $(dataset).each(function (index) {
        ...
        var name2 = dataset[index].NutzungsID;
        var ort = dataset[index].OrtsID;

        newEvent(first, second, name);
        pushICS(first, second, name2, ort)
...
function pushICS(first, second, name, ort) {
    //subject, description, location, begin, end

    ics_file.addEvent(name, '', ort, first, second);
